...
WebUI.navigateToUrl('https://bda.co.th/testimonials')
...
WebUI.click(findTestObject('Object Repository/Page_BIG DATA AGENCY/img (1)'))

WebUI.doubleClick(findTestObject('Object Repository/Page_BIG DATA AGENCY/button_Next'))
